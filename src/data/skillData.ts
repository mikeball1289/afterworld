...
export let explosion = new Skill(icon(7, 0), sf.explosion, [new Cost("energy", 50)], ["heavy", "magic"], 2, "Explosion", "Summon a fiery explosion around yourself, knocking back nearby enemies and dealing up to <cyan>180%</cyan> <red>fire</red> damage to enemies close to you.");
...
export let sentinelFlames = new Skill(icon(9, 0), sf2.sentinelFlames, [new Cost("energy", 25)], ["magic"], 0, "Sentinel Flames", "Surround yourself with 3 orbitting flames that explode for <cyan>140%</cyan> <red>fire</red> damage when they hit an enemy.");
