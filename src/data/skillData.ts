...
export let tremor = new Skill(icon(4, 0), sf.tremor, [new Cost("energy", 15)], ["heavy", "magic"], 10, "Tremor", "Emit a shockwave that stuns enemies within 2 yards for 2 seconds.");
export let buckleDown = new Skill(icon(5, 0), sf.buckleDown, [new Cost("energy", 25)], "any", 12, "Buckle Down", "Brace yourself against incoming attacks for 6 seconds, ignoring knockbacks and reducing damage by 50%.", false);
...
export let pounce = new Skill(icon(2, 1), sf2.pounce, [new Cost("energy", 7)], ["heavy", "light"], 4, "Pounce", "Pounce forward and swing your weapon for <or>120%</or> physical damage.");
export let ambush = new Skill(icon(3, 1), sf.ambush, [new Cost("energy", 10)], ["light"], 6, "Ambush", "Hit'em a bunch");
export let quickStrike = new Skill(icon(4, 1), sf.quickStrike, [new Cost("energy", 4)], ["light", "heavy"], 2, "Quick Strike", "Quickly swing your weapon for 80% damage. Doesn't use global cooldown.", false);
export let ascention = new Skill(icon(5, 1), sf2.ascention, [new Cost("energy", 1)], "none", 0, "Ascention", "While airborn, give yourself an upwards boost with a flap of angelic wings.", false);
