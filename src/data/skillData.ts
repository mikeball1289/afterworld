...
let skills = {
    basic_attack: new Skill(icon(0, 0), sf.basicAttack, [], "any", 0, "Basic Attack", "Swing your weapon to deal 100% physical damage."),
    cleave: new Skill(icon(1, 0), sf.cleave, [new Cost("energy", 5)], ["heavy"], 0, "Cleave", "Deal 150% physical damage to the first enemy hit and 100% physical damage to up to 2 other enemies."),
    ...
    envenom: new Skill(icon(2, 0), sf.envenom, [new Cost("energy", 15)], "any", 15 * FPS, "Envenom", "Coat your weapon in poison causing the next 3 enemies attacked to be poisoned for 100% physical damage over 4 seconds.", false),
